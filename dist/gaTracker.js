...
var initGtag = function initGtag() {
  ...
  if (LittledataLayer.MPEndpoint) {
    var length = LittledataLayer.MPEndpoint.length; // remove '/collect' from end, since it is added by gtag

    var transport_url = LittledataLayer.MPEndpoint.slice(0, length - '/collect'.length);
    gtag('config', 'CUSTOM-ENDPOINT', _objectSpread({}, getConfig(), {
